...
test_output_contains("pew[1:2,]",
                     incorrect_msg = "Did you look at the first few lines of `pew`")
test_output_contains("pew[(nrow(pew)-1):nrow(pew),]",
                     incorrect_msg = "Did you look at the las few lines of `pew`")
test_output_contains("nrow(pew)",
                     incorrect_msg = "Did you look at the dimensions of `pew` (rows and columns)?")
test_output_contains("ncol(pew)",
                     incorrect_msg = "Did you look at the dimensions of `pew` (rows and columns)?")
test_output_contains("summary(pew)",
                     incorrect_msg = "Did you get a summary of the data in `pew`?")
test_output_contains("str(pew)",
                     incorrect_msg = "Did you look at the structure of the data in `pew`?")
