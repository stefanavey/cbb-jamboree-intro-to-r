...
*** =pre_exercise_code
```{r}
load(url("http://s3.amazonaws.com/assets.datacamp.com/production/course_1843/datasets/pew.RData"))
...
iris_df <- tidyr::gather(iris, Species, value)
head(iris_df) # there exist duplicate colnames, fix below
colnames(iris_df) <- c("Species", "Measurement", "value") 
