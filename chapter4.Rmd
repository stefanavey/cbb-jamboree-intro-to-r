...
*** =pre_exercise_code
```{r}
load(url("http://s3.amazonaws.com/assets.datacamp.com/production/course_cbb-jamboree-intro-to-r/datasets/eset.RData"))
```
...
# test_function("gather", args = c("data", "key", "value", "..."))
 test_object("dat",
             ...
             incorrect_msg = "Looks like `dat` is not set properly. Check your `tidyr::gather()` call")
