...
- Explore the `mtcars` dataset with [`head()`](http://www.rdocumentation.org/packages/utils/functions/head) and [`str()`](http://www.rdocumentation.org/packages/utils/functions/str) to get a feel for the dataset
- Execute the `ggplot2` code, and see if you can understand what each part does
